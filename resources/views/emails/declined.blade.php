                        ...
                        <tr>
                           <td>
                            <div class="text" style="padding: 0 2.5em; text-align: center;">
                                 <h2>Your registration has been declined due to one or various reasons </h2>
                                 <h3>Have sent the details on your registered email id </h3>
                                 <h3>Kindly rectify as per email or contact admin for further assistance.</h3>
                                 <hr>
                                 <h3>Thanks, <br>
                                 Team
                                 </h3>
