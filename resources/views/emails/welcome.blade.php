                        ...
                        <tr>
                           <td>
                              <div class="text" style="padding: 0 2.5em; text-align: center;">
                                 <h2>Thanks for signing as Seller with {{$email}}.</h2>
                                 <h3>We welcome you to digital world to sell your products directly to customer .</h3>
                                 <h3>We will be sending activation  confirmation to your registered email id within 2 working days .</h3>
                                 <hr>
                                 <h4>Thanks</h4>
                                 <h4>TEAM</h4>
                              </div>
